vanus = int(input("Siseta enda vanus: "))
sugu = input("Sisetage oma sugu: ")
if sugu == "M" or sugu == "m":
    max_pulsi_sagedus = 220 - vanus
if sugu == "N" or sugu == "n":
    max_pulsi_sagedus = 206 - vanus * 0.88
treening = int(input("Siseta treeningu tüüp: "))
if treening == 1:
...
print("Pulsisagedus peab olema vahemikus " + str(min_puls) + " kuni " + str(max_puls) + " vahel.")
